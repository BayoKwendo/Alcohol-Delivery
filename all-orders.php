...
<head>
  ...
  ns/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
                ...
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">
                        DaPlace
                      </a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
...
<div id="work-collections" class="seaction">
               ...
               if ($the > 0) {
                            ...
                            <span>'.$row1['price'].'./=</span>
								...
								echo '<br><button class="btn waves-effect waves-light right submit" type="submit" name="action">Change Status
