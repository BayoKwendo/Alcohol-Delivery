            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#"  class="waves-effect waves-block waves-light"><i class="mdi-editor-attmoney">DaPlace</i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
...
<div id="work-collections" class="seaction">
               ...
               if ($the > 0) {
                            ...
                            <div class="col s4">
                            <span>'.$row1['quantity'].' Bottles</span>
                            </div>
                            <div class="col s3">
							...
							$id = $row1['order_id'];
								...
								echo '<form action="routers/cancel-order.php" method="post">
										...
										<br><br><button class="btn waves-effect waves-light right submit" type="submit" name="action">Cancel Order
