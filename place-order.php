      ...
      <div class="navbar-fixed">
        <nav class="navbar-color">
          <div class="nav-wrapper">
            <ul class="left">                      
              <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1">DaPlace</a> <span class="logo-text">Logo</span></h1></li>
            </ul>
            <ul class="right hide-on-med-and-down">                        
              <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attach">DaPlace</i></a>
              </li>
            </ul>						
          </div>
        </nav>
            ...
            <div class="divider"></div>
              ...
              <div>
                <div class="card-panel">
                  <div class="row">
                    <form class=" col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      <div class="row">
                     ...
                     <div class="row">
                      ...
                      <div class="input-field col s12">
                        ...
                        <input type="text" name="address" value="<?php echo $address;?>" id="address" class="materialize-textarea validate" data-error=".errorTxt1"/>
          ...
          <div class="row">
            <div>
              <ul id="issues-collection" class="collection">
                ...
                <p><strong>Name:</strong>&nbsp '.$name.'</p>
                <p><strong>Contact Number:</strong>&nbsp'.$contact.'</p>
