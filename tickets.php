        ...
        <nav class="navbar-color">
          <div class="nav-wrapper">
            ...
            <ul class="right hide-on-med-and-down">                        
              <li><a href="#" class="waves-effect waves-block waves-light"><i class="mdi-editor-attachoney">DaPlace</i></a>
              </li>
            </ul>					
          </div>
        </nav>
        ...
        <div class="row">
          <div class="col s12 m4 l3">
            ...
            <h4 class="header">Open a ticket</h4>
             ...
             <?php  
             if (@$_GET['action']=='fail') {
                       echo'<h6  style="color: red">Kindly Choose type of issues</h6>';
                     }
            ...
            <div class="card-panel">
                <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.php" novalidate="novalidate" class="col s12">
                  ...
                  <div class="row">
                    <div class="input-field col s12">
                     <select name="type">
                      <option disabled selected><marquee><i>Choose a type</i></marquee></option>
      ...
      <div id="work-collections" >
       <ul id="projects-collection" class="collection">
        ...
        while($row = mysqli_fetch_array($sql)){								                                
         ...
         <span class="badge" class="pull-right">'.$row['date'].'</span></div>
         </div>
         </a>';
       }
       ?>
