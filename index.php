            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><i class="-editor-attach-money">DaPlace</i></a>
                        </li>
                    </ul>					
                </div>
            </nav>
            ...
            <div class="row">
              ...
              <div>
                  <table id="data-table-customer" class="responsive-table display" cellspacing="0">
                    <thead>
                      <tr>
                        <th>Name (<b style="color: red">Kindly scroll-></b>)</th>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<input id="'.$row["id"].'" name="'.$row['id'].'" value ="0" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td></tr>';
